...
if (typeof window !== 'undefined') {
  window.addEventListener('load', function() {
    setTimeout(function() {
      alert("当前版本已更新，点击蓝色字体（确定）体验最新产品,版本新增：ChatGPT4.0功能（官网20$/月）、AI专业绘画midjourney功能（官网30$/月），新增AI图生图功能，新增上百种专业提示词，新增角色仓库功能，新增代理分销变现功能，期待您的探索~");
      // 跳转到指定页面
    ...
    >
      <div className={styles["sidebar-header"]}>
        ...
        <div className={styles["sidebar-sub-title"]} style={{ margin: '10px 0' }}>
          {/* wk */}
          <a style={{ textDecoration: 'none' }} href='https://s.pdb2.com/pages/20230510/dNqgN8dGkIoO8gE.html'>欢迎使用ChatGPT,点击我加入AI交流群.</a>
        </div>
        <div className={styles["sidebar-sub-title"]} style={{ margin: '10px 0' }}>
